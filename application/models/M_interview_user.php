...
class M_interview_user extends CI_Model {     
    var $table = 'kandidat';     
    ...
    'status','tgl_input','rencana_posisi','pengalaman_kerja','jenis_interview','nilai','status_nilai','saran_posisi','hasil_wawancara','lup'); //set column field database for datatable orderable     
    ...
    private function _get_datatables_query()
    {
        ...
        $this->db->where('jenis_interview','User');
