...
class M_kandidat extends CI_Model {     
    ...
    'status','tgl_input','rencana_posisi','pengalaman_kerja','vaksin1','vaksin2','booster',null); //set column field database for datatable orderable     
    ...
    private function _get_datatables_query()
    {
        ...
        // $this->db->where('area',$this->session->userdata('area'));
