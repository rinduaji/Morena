          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-header">
                <h4 class="card-title"> Tabel Caplan</h4>
              </div>
              <div class="card-body">
                <button class="btn btn-success" onclick="add_caplan()"><i class="glyphicon glyphicon-plus"></i> Add Caplan</button>
                ...
                <div class="table-responsive">
                  <table id="table" class="table">
                    <thead class="text-primary">
                            ...
                            <th style="font-weight:bold; font-size:14px;">Jumlah Caplan</th>
                            <th style="font-weight:bold; font-size:14px;">Tanggal Input</th>
                            <th style="font-weight:bold; font-size:14px;">UPD</th>
                            <th style="font-weight:bold; font-size:14px;">Tanggal Awal</th>
                            <th style="font-weight:bold; font-size:14px;">Tanggal Akhir</th>
...
$(document).ready(function() {
    ...
    table = $('#table').DataTable({ 
        ...
        "ajax": {
            "url": "<?php echo site_url('caplan/ajax_list')?>",
            "type": "POST"
        },
...
function add_caplan()
{
    ...
    $('.modal-title').text('Add caplan'); // Set Title to Bootstrap modal title
...
function edit_caplan(id)
{
    ...
    $.ajax({
        url : "<?php echo site_url('caplan/ajax_edit')?>/" + id,
        type: "GET",
        dataType: "JSON",
        success: function(data)
        {
            ...
            $('[name="jumlah_caplan"]').val(data.jumlah_caplan);
            ...
            $('.modal-title').text('Edit caplan'); // Set title to Bootstrap modal title
...
function save()
{
    ...
    if(save_method == 'add') {
        url = "<?php echo site_url('caplan/ajax_add')?>";
    } else {
        url = "<?php echo site_url('caplan/ajax_update')?>";
    }
...
function delete_caplan(id)
{
    if(confirm('Are you sure delete this data?'))
    {
        // ajax delete data to database
        $.ajax({
            url : "<?php echo site_url('caplan/ajax_delete')?>/"+id,
            type: "POST",
            dataType: "JSON",
            success: function(data)
            {
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h3 class="modal-title">Caplan Form</h3>
            ...
            <div class="modal-body form">
                <form action="#" id="form" class="form-horizontal">
                    ...
                    <div class="form-body">
                        ...
                        <div class="form-group">
                            <label class="control-label col-md-6">Jumlah Caplan</label>
                            <div class="col-md-12">
                                <input name="jumlah_caplan" placeholder="Jumlah Caplan" class="form-control" type="text" onkeypress="return hanyaAngka(event)">
                                <span class="help-block"></span>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <!-- <div class="form-group">
                            ...
                            <div class="col-md-12"> -->
                                <input name="upd" placeholder="UPD" class="form-control" type="hidden" value="<?=$this->session->userdata('nama')?>" onkeypress="return hanyaAngka(event)">
                                <!-- <span class="help-block"></span>
                            </div>
                        </div> -->
                        <div class="form-group">
                            <label class="control-label col-md-6">Tanggal Awal</label>
                            <div class="col-md-12">
                                <input name="tgl_awal" placeholder="Tanggal Awal" class="form-control datepicker" type="text">
                                <span class="help-block"></span>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="control-label col-md-6">Tanggal Akhir</label>
                            <div class="col-md-12">
                                <input name="tgl_akhir" placeholder="Tanggal Akhir" class="form-control datepicker" type="text">
                                <span class="help-block"></span>
                            </div>
                        </div>
                    </div>
