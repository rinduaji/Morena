          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-header">
                <h4 class="card-title"> Tabel CV</h4>
              </div>
              <div class="card-body">
                <button class="btn btn-success" onclick="add_cv()"><i class="glyphicon glyphicon-plus"></i> Add CV</button>
                ...
                <div class="table-responsive">
                  <table id="table" class="table">
                    <thead class="text-primary">
                            ...
                            <th style="font-weight:bold; font-size:14px;">Jumlah CV</th>
...
$(document).ready(function() {
    ...
    table = $('#table').DataTable({ 
        ...
        "ajax": {
            "url": "<?php echo site_url('cv/ajax_list')?>",
            "type": "POST"
        },
...
function add_cv()
{
    ...
    $('.modal-title').text('Add cv'); // Set Title to Bootstrap modal title
...
function edit_cv(id)
{
    ...
    $.ajax({
        url : "<?php echo site_url('cv/ajax_edit')?>/" + id,
        type: "GET",
        dataType: "JSON",
        success: function(data)
        {
            ...
            $('[name="jumlah_cv"]').val(data.jumlah_cv);
            ...
            $('.modal-title').text('Edit cv'); // Set title to Bootstrap modal title
...
function save()
{
    ...
    if(save_method == 'add') {
        url = "<?php echo site_url('cv/ajax_add')?>";
    } else {
        url = "<?php echo site_url('cv/ajax_update')?>";
    }
...
function delete_cv(id)
{
    if(confirm('Are you sure delete this data?'))
    {
        ...
        $.ajax({
            url : "<?php echo site_url('cv/ajax_delete')?>/"+id,
            type: "POST",
            dataType: "JSON",
            success: function(data)
            {
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h3 class="modal-title">CV Form</h3>
            ...
            <div class="modal-body form">
                <form action="#" id="form" class="form-horizontal">
                    ...
                    <div class="form-body">
                        ...
                        <div class="form-group">
                            <label class="control-label col-md-6">Jumlah CV</label>
                            <div class="col-md-12">
                                <input name="jumlah_cv" placeholder="Jumlah CV" class="form-control" type="text" onkeypress="return hanyaAngka(event)">
                                <span class="help-block"></span>
                            </div>
                        </div>
                        <div class="form-group">
