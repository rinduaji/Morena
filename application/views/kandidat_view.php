          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-header">
                <h4 class="card-title"> Tabel Kandidat</h4>
              </div>
              <div class="card-body">
                <button class="btn btn-success" onclick="add_kandidat()"><i class="glyphicon glyphicon-plus"></i> Add Kandidat</button>
                ...
                <div class="table-responsive">
                  <table id="table" class="table">
                    <thead class="text-primary">
                            ...
                            <th style="font-weight:bold; font-size:14px;">Vaksin 1</th>
                            <th style="font-weight:bold; font-size:14px;">Vaksin 2</th>
                            <th style="font-weight:bold; font-size:14px;">Booster</th>
...
$(document).ready(function() {
    ...
    table = $('#table').DataTable({ 
        ...
        "ajax": {
            "url": "<?php echo site_url('kandidat/ajax_list')?>",
            "type": "POST"
        },
...
function add_kandidat()
{
    ...
    $('.modal-title').text('Add kandidat'); // Set Title to Bootstrap modal title
...
function edit_kandidat(id)
{
    ...
    $.ajax({
        url : "<?php echo site_url('kandidat/ajax_edit')?>/" + id,
        type: "GET",
        dataType: "JSON",
        success: function(data)
        {
            ...
            $('[name="tgl_lahir"]').val(formatDate(data.tgl_lahir));
            ...
            $('[name="booster"]').val(data.booster);
            // $('[name="tgl_input"]').datepicker('update',data.tgl_input);
            $('#modal_form').modal('show'); // show bootstrap modal when complete loaded
            $('.modal-title').text('Edit kandidat'); // Set title to Bootstrap modal title
...
function save()
{
    ...
    if(save_method == 'add') {
        url = "<?php echo site_url('kandidat/ajax_add')?>";
    } else {
        url = "<?php echo site_url('kandidat/ajax_update')?>";
    }
...
function delete_kandidat(id)
{
    if(confirm('Are you sure delete this data?'))
    {
        // ajax delete data to database
        $.ajax({
            url : "<?php echo site_url('kandidat/ajax_delete')?>/"+id,
            type: "POST",
            dataType: "JSON",
            success: function(data)
            {
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h3 class="modal-title">Kandidat Form</h3>
                ...
                <form action="#" id="form" class="form-horizontal">
                    ...
                    <div class="form-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-12">
                                <input name="status" placeholder="Status" class="form-control" type="hidden" value="Kandidat">
                                <span class="help-block"></span>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-12">
                                <textarea name="pengalaman_kerja" placeholder="Pengalaman Kerja" class="form-control"></textarea>
                                <span class="help-block"></span>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="control-label col-md-6">Vaksin 1</label>
                            <div class="col-md-12">
                                <select name="vaksin1" class="form-control">
                                    <option value="">--Select Vaksin 1--</option>
                        ...
                        <div class="form-group">
                            <label class="control-label col-md-6">Vaksin 2</label>
                            <div class="col-md-12">
                                <select name="vaksin2" class="form-control">
                                    <option value="">--Select Vaksin 2--</option>
                                    <option value="Sudah">Sudah</option>
                                    <option value="Belum">Belum</option>
                                </select>
                                <span class="help-block"></span>
                        ...
                        <div class="form-group">
                            <label class="control-label col-md-6">Booster</label>
                            <div class="col-md-12">
                                <select name="booster" class="form-control">
