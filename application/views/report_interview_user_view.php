          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-header">
                <h4 class="card-title"> Tabel Report Interview User</h4>
              </div>
              <div class="card-body">
                <!-- <button class="btn btn-success" onclick="add_interview_user()"><i class="glyphicon glyphicon-plus"></i> Add Interview User</button>
...
$(document).ready(function() {
    ...
    table = $('#table').DataTable({ 
        ...
        "ajax": {
            "url": "<?php echo site_url('InterviewUser/ajax_list')?>",
            "type": "POST"
        },
...
function add_interview_user()
{
    ...
    $('.modal-title').text('Add InterviewUser'); // Set Title to Bootstrap modal title
...
function edit_interview_user(id)
{
    save_method = 'update';
    $('#form')[0].reset(); // reset form on modals
    $('.form-group').removeClass('has-error'); // clear error class
    ...
    $.ajax({
        url : "<?php echo site_url('InterviewUser/ajax_edit')?>/" + id,
        type: "GET",
        dataType: "JSON",
        success: function(data)
        {
            ...
            $('.modal-title').text('Edit InterviewUser'); // Set title to Bootstrap modal title
...
function save()
{
    ...
    if(save_method == 'add') {
        url = "<?php echo site_url('InterviewUser/ajax_add')?>";
    } else {
        url = "<?php echo site_url('InterviewUser/ajax_update')?>";
    }
...
function delete_interview_user(id)
{
    if(confirm('Are you sure delete this data?'))
    {
        // ajax delete data to database
        $.ajax({
            url : "<?php echo site_url('InterviewUser/ajax_delete')?>/"+id,
            type: "POST",
            dataType: "JSON",
            success: function(data)
            {
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h3 class="modal-title">InterviewUser Form</h3>
                ...
                <form action="#" id="form" class="form-horizontal">
                    ...
                    <div class="form-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-12">
                                <input name="status" placeholder="Status" class="form-control" type="hidden" value="InterviewUser">
                                <span class="help-block"></span>
                            </div>
                        </div>
                        <div class="form-group">
