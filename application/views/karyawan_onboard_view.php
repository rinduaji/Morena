        ...
        <div class="row">
          <div class="col-md-12">
            <div class="card">
              ...
              <div class="card-body">
                <button class="btn btn-success" onclick="add_karyawan_onboard()"><i class="glyphicon glyphicon-plus"></i> Add Bank</button>
...
$(document).ready(function() {
    ...
    table = $('#table').DataTable({ 
        ...
        "ajax": {
            "url": "<?php echo site_url('karyawan_onboard/ajax_list')?>",
            "type": "POST"
        },
...
function edit_karyawan_onboard(id)
{
    save_method = 'update';
    $('#form')[0].reset(); // reset form on modals
    $('.form-group').removeClass('has-error'); // clear error class
    ...
    $.ajax({
        url : "<?php echo site_url('karyawan_onboard/ajax_edit')?>/" + id,
        type: "GET",
        dataType: "JSON",
...
function save()
{
    ...
    if(save_method == 'add') {
        url = "<?php echo site_url('karyawan_onboard/ajax_add')?>";
    } else {
        url = "<?php echo site_url('karyawan_onboard/ajax_update')?>";
    }
...
function delete_karyawan_onboard(id)
{
    if(confirm('Are you sure delete this data?'))
    {
        // ajax delete data to database
        $.ajax({
            url : "<?php echo site_url('karyawan_onboard/ajax_delete')?>/"+id,
            type: "POST",
            dataType: "JSON",
            success: function(data)
            {
