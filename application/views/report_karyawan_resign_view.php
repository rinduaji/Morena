        ...
        <div class="row">
          <div class="col-md-12">
            <div class="card">
              ...
              <div class="card-body">
                <!-- <button class="btn btn-success" onclick="add_report_karyawan_resign()"><i class="glyphicon glyphicon-plus"></i> Add Report Karyawan</button> -->
                ...
                <div class="table-responsive">
                  <table id="table" class="table">
                    <thead class="text-primary">
                            ...
                            <th style="font-weight:bold; font-size:14px;">Tanggal Resign</th>
...
$(document).ready(function() {
    ...
    table = $('#table').DataTable({ 
        ...
        "ajax": {
            "url": "<?php echo site_url('ReportKaryawanResign/ajax_list')?>",
            "type": "POST"
        },
...
function add_report_karyawan_resign()
{
    save_method = 'add';
...
function edit_report_karyawan_resign(id)
{
    save_method = 'update';
    $('#form')[0].reset(); // reset form on modals
    $('.form-group').removeClass('has-error'); // clear error class
    ...
    $.ajax({
        url : "<?php echo site_url('ReportKaryawanResign/ajax_edit')?>/" + id,
        type: "GET",
        dataType: "JSON",
...
function save()
{
    ...
    if(save_method == 'add') {
        url = "<?php echo site_url('ReportKaryawanResign/ajax_add')?>";
    } else {
        url = "<?php echo site_url('ReportKaryawanResign/ajax_update')?>";
    }
...
function delete_report_karyawan_resign(id)
{
    if(confirm('Are you sure delete this data?'))
    {
        // ajax delete data to database
        $.ajax({
            url : "<?php echo site_url('ReportKaryawanResign/ajax_delete')?>/"+id,
            type: "POST",
            dataType: "JSON",
            success: function(data)
            {
