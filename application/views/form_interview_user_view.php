      ...
      <div class="content">
        <div class="row">
          <div class="col-md-12">
          <form id="form" action="<?=site_url('FormInterviewUser/ajax_add')?>" method="post" enctype="multipart/form-data">
            <div class="card">
              <div class="card-header">
                <h4 class="card-title">Data Kandidat Interview User</h4>
                <?php
                ...
                <input type="hidden" name="upd" class="form-control" value="<?=$this->session->userdata('username')?>" readonly> 
                            ...
                            <div class="form-body">
                                  <div class="form-group row">
                                    <label class="col-md-3">Nama Kandidat Interview User</label>
                                    <div class="col-md-9">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                <select name="id_kandidat" id="id_kandidat" class="form-control">
                                                    <option value="">--Select Nama Kandidat Interview User--</option>
                                                    <?php
                                ...
                                <div class="form-group row">
                                    <label class="col-md-3">Rencana Posisi</label>
                                    <div class="col-md-9">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                ...
                                <div class="form-group row">
                                    <label class="col-md-3">User Interview</label>
                                    <div class="col-md-9">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                  <input name="user_interview" class="form-control" placeholder="User Interview" readonly>
                                                  <span class="help-block"></span>
                                                </div>
                                            </div>
                                        </div>
            ...
            <div class="card">
              ...
              <div class="card-body">
                <p>* Tinggi (Nilai : 90 - 100)</p>
                <p>* Baik (Baik : 80 - 89)</p>
                <p>* Cukup (Cukup : 70 - 79)</p>
                <p>* Kurang (Kurang : 0 - 69)</p>
              </div>
          </div>
        </div>
      </div>
  ...
  $(document).ready(function() {
      ...
      function edit_form_interview_hr(id)
    {
        ...
        $.ajax({
            url : "<?php echo site_url('FormInterviewUser/ajax_edit')?>/" + id,
            type: "GET",
            dataType: "JSON",
            success: function(data)
            {
                ...
                $('[name="user_interview"]').val(data.user_interview);
            },
    ...
    function save()
    {
        ...
        url = "<?php echo site_url('FormInterviewUser/ajax_add')?>";
