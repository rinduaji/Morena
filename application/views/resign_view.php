          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-header">
                <h4 class="card-title">Tabel Resign</h4>
              </div>
              <div class="card-body">
                <!-- <button class="btn btn-success" onclick="add_resign()"><i class="glyphicon glyphicon-plus"></i> Add Bank</button> -->
                ...
                <div class="table-responsive">
                  <table id="table" class="table">
                    <thead class="text-primary">
                            ...
                            <th style="font-weight:bold; font-size:14px;">Keterangan Resign</th>
...
$(document).ready(function() {
    ...
    table = $('#table').DataTable({ 
        ...
        "ajax": {
            "url": "<?php echo site_url('resign/ajax_list')?>",
            "type": "POST"
        },
...
function add_resign()
{
    ...
    $('.modal-title').text('Add Resign'); // Set Title to Bootstrap modal title
...
function edit_resign(id)
{
    ...
    $.ajax({
        url : "<?php echo site_url('resign/ajax_edit')?>/" + id,
        type: "GET",
        dataType: "JSON",
        success: function(data)
        {
            $('[name="id"]').val(data.id);
            $('[name="keterangan_resign"]').val(data.keterangan_resign);
            $('#modal_form').modal('show'); // show bootstrap modal when complete loaded
            $('.modal-title').text('Edit Resign'); // Set title to Bootstrap modal title
...
function save()
{
    ...
    if(save_method == 'add') {
        url = "<?php echo site_url('resign/ajax_add')?>";
    } else {
        url = "<?php echo site_url('resign/ajax_update')?>";
    }
...
function delete_resign(id)
{
    if(confirm('Are you sure delete this data?'))
    {
        ...
        $.ajax({
            url : "<?php echo site_url('resign/ajax_delete')?>/"+id,
            type: "POST",
            dataType: "JSON",
            success: function(data)
            {
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h3 class="modal-title">Resign Form</h3>
                ...
                <form action="#" id="form" class="form-horizontal">
                    ...
                    <div class="form-body">
                        <div class="form-group">
                            <label class="control-label col-md-6">Keterangan Resign</label>
                            <div class="col-md-12">
                                <input name="keterangan_resign" placeholder="Keterangan Resign" class="form-control" type="text" onkeypress="return event.charCode < 48 || event.charCode  >57">
