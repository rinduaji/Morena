...
class FormInterviewUser extends CI_Controller {
    ...
    public function index()
    {
        ...
        $data['kandidat'] = $this->M_form_interview_hr->nama_interview_hr($this->session->userdata('nama'));
        ...
        $this->load->view('form_interview_user_view', $data);
    ...
    public function ajax_add()
    {
        ...
        redirect(site_url('InterviewUser'));
